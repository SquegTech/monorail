...
class Race {
    static DOMContentLoaded(ev) {
        ...
        document.querySelector("#timer").addEventListener("mousedown", (ev) => {
            switch (ev.button) {
                case 0:
        ...
        document.querySelector("#timer").addEventListener("oncontextmenu", () => false);

        document.querySelector("#left-victories").addEventListener("click", () => {
        ...
        document.querySelector("#right-victories").addEventListener("click", () => {
    ...
    static updateTimer() {
        ...
        timer.text = `${diff >= 60 * 60 * 1000 ? `${Math.floor(diff / (60 * 60 * 1000))}:` : ""}${`0${Math.floor((diff % (1000 * 60 * 60)) / (1000 * 60)).toString()}`.slice(diff >= 10 * 60 * 1000 ? -2 : -1)}:${`0${Math.floor((diff % (1000 * 60)) / 1000).toString()}`.slice(-2)}.${`0${Math.floor((diff % 1000) / 10)}`.slice(-2)}`;
    }
}
...
SpriteFont.setup({
    ...
    letters: {
        ...
        "!": {left: 8, top: 0, width: 8, height: 10},
        "?": {left: 16, top: 0, width: 8, height: 10},
        "#": {left: 24, top: 0, width: 8, height: 10},
        "$": {left: 32, top: 0, width: 8, height: 10},
        "%": {left: 40, top: 0, width: 8, height: 10},
        "&": {left: 48, top: 0, width: 8, height: 10},
        "'": {left: 56, top: 0, width: 8, height: 10},
        "(": {left: 64, top: 0, width: 8, height: 10},
        ")": {left: 72, top: 0, width: 8, height: 10},
        "[": {left: 80, top: 0, width: 8, height: 10},
        "]": {left: 88, top: 0, width: 8, height: 10},
        "*": {left: 96, top: 0, width: 8, height: 10},
        "+": {left: 104, top: 0, width: 8, height: 10},
        ",": {left: 112, top: 0, width: 8, height: 10},
        "-": {left: 120, top: 0, width: 8, height: 10},
        ".": {left: 132, top: 0, width: 3, height: 10},
        "/": {left: 136, top: 0, width: 8, height: 10},
        "0": {left: 144, top: 0, width: 8, height: 10},
        "1": {left: 152, top: 0, width: 8, height: 10},
        "2": {left: 160, top: 0, width: 8, height: 10},
        "3": {left: 168, top: 0, width: 8, height: 10},
        "4": {left: 176, top: 0, width: 8, height: 10},
        "5": {left: 184, top: 0, width: 8, height: 10},
        "6": {left: 192, top: 0, width: 8, height: 10},
        "7": {left: 200, top: 0, width: 8, height: 10},
        "8": {left: 208, top: 0, width: 8, height: 10},
        "9": {left: 216, top: 0, width: 8, height: 10},
        ":": {left: 226, top: 0, width: 3, height: 10},
        ";": {left: 232, top: 0, width: 8, height: 10},
        "^": {left: 240, top: 0, width: 8, height: 10},
        "_": {left: 248, top: 0, width: 8, height: 10},
        "`": {left: 256, top: 0, width: 8, height: 10},
        "A": {left: 264, top: 0, width: 8, height: 10},
        "B": {left: 272, top: 0, width: 8, height: 10},
        "C": {left: 280, top: 0, width: 8, height: 10},
        "D": {left: 288, top: 0, width: 8, height: 10},
        "E": {left: 296, top: 0, width: 8, height: 10},
        "F": {left: 304, top: 0, width: 8, height: 10},
        "G": {left: 312, top: 0, width: 8, height: 10},
        "H": {left: 320, top: 0, width: 8, height: 10},
        "I": {left: 328, top: 0, width: 8, height: 10},
        "J": {left: 336, top: 0, width: 8, height: 10},
        "K": {left: 344, top: 0, width: 8, height: 10},
        "L": {left: 352, top: 0, width: 8, height: 10},
        "M": {left: 360, top: 0, width: 8, height: 10},
        "N": {left: 368, top: 0, width: 8, height: 10},
        "O": {left: 376, top: 0, width: 8, height: 10},
        "P": {left: 384, top: 0, width: 8, height: 10},
        "Q": {left: 392, top: 0, width: 8, height: 10},
        "R": {left: 400, top: 0, width: 8, height: 10},
        "S": {left: 408, top: 0, width: 8, height: 10},
        "T": {left: 416, top: 0, width: 8, height: 10},
        "U": {left: 424, top: 0, width: 8, height: 10},
        "V": {left: 432, top: 0, width: 8, height: 10},
        "W": {left: 440, top: 0, width: 8, height: 10},
        "X": {left: 448, top: 0, width: 8, height: 10},
        "Y": {left: 456, top: 0, width: 8, height: 10},
        "Z": {left: 464, top: 0, width: 8, height: 10},
        "Ä": {left: 472, top: 0, width: 8, height: 10},
        "Ö": {left: 480, top: 0, width: 8, height: 10},
        "Ü": {left: 488, top: 0, width: 8, height: 10},
        "a": {left: 264, top: 0, width: 8, height: 10},
        "b": {left: 272, top: 0, width: 8, height: 10},
        "c": {left: 280, top: 0, width: 8, height: 10},
        "d": {left: 288, top: 0, width: 8, height: 10},
        ...
        "ö": {left: 480, top: 0, width: 8, height: 10},
        "ü": {left: 488, top: 0, width: 8, height: 10},
        "ß": {left: 496, top: 0, width: 8, height: 10}
    }
});
